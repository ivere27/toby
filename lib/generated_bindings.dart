...
class NativeLibrary {
  ...
  void tobyInit(
    ffi.Pointer<ffi.Char> processName,
    ffi.Pointer<ffi.Char> userScript,
    TobyOnloadCB arg2,
    TobyOnunloadCB arg3,
    TobyHostcallCB arg4,
  ...
  late final _tobyJSCompilePtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Char>,
              ffi.Size)>>('tobyJSCompile');
  late final _tobyJSCompile = _tobyJSCompilePtr.asFunction<
      int Function(ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Char>, int)>();
  ...
  late final _tobyJSCallPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Char>,
              ffi.Pointer<ffi.Char>, ffi.Size)>>('tobyJSCall');
  late final _tobyJSCall = _tobyJSCallPtr.asFunction<
  ...
  late final _tobyJSEmitPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(
              ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Char>)>>('tobyJSEmit');
  late final _tobyJSEmit = _tobyJSEmitPtr
  ...
  late final _tobyHostOnPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(ffi.Pointer<ffi.Char>, TobyHostonCB)>>('tobyHostOn');
  late final _tobyHostOn = _tobyHostOnPtr
      .asFunction<int Function(ffi.Pointer<ffi.Char>, TobyHostonCB)>();
}
